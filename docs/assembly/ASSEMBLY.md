...
2. Bond the 71 × 25 × 1 mm polycarbonate window into the lid recess with a
...
3. Fit the LCD behind the window without loading the display glass. Secure its PCB
   to the designed supports and connect the keyed header.
...
8. Fit the perimeter gasket dry and continuous in its groove. Do not stretch it.
