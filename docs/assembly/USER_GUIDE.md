...
The enclosure is designed for drizzle, dust, and incidental sand with its USB cap
installed. It has no certified IP rating. Do not immerse it or charge it while wet.

## Configuration and recovery

Install Python 3.11+, Tkinter, and the configurator as described in
`configurator/README.md`. Profiles contain display and behavior settings but never
